...
class PPOExpConfig(BasePPOExpConfig):
    ...
    pretrain: Optional[str] = f"{prefix}/orz_ckpt/student_training_student_only_aug-originalqwen-studentonly-273/iter50/policy"  #f"{prefix}/binary_noncol_orz_1p5b_ppo_grpo-base-explain-v0-824/iter150/policy" #f"{prefix}/iter104/policy" #f"{prefix}/iter50/policy" #f"{prefix}/Qwen2.5-1.5B" # TODO: or put your downloaded model path here!
    ...
    teacher_pretrain: Optional[str] = f"{prefix}/orz_ckpt/student_training_student_only_aug-originalqwen-studentonly-273/iter50/policy" #f"{prefix}/orz_ckpt/teacher_training_ppo_debug_aug-iter50-correct-949/iter50/policy" #"teacher_training_ppo_debug_aug-iter50-correct-949"

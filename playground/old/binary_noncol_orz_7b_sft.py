...
class PPOExpConfig(BasePPOExpConfig):
    ...
    generate_max_len: int = 2048 #8000  # 2000 #4000 # TODO: change to larger later
    max_len: int = 3072 #8192  #2560 #4192 # TODO: change to larger later
    ...
    student_training_rounds: int = 1000000  # number student training rounds, -1 means no student training

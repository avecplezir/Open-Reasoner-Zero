...
class PPOExpConfig(BasePPOExpConfig):
    ...
    teacher_pretrain: Optional[str] = f"{prefix}/checkpoints/teacher_training_7b_to1p5b_558/iterteacher-30/policy"
    # teacher_pretrain: Optional[str] = f"{prefix}/orz_ckpt/teacher_training_reverse_7b_to1p5b_952/iterteacher-30/policy"
